...
public:
    ...
    Vehicle(string Vehicle_Type, int Vehicle_Length, int Vehicle_Width, int Vehicle_MaxSpeed, int Vehicle_Max_Acceleration, string Vehicle_Colour);
    ~Vehicle();
    ...
    struct nextVehicleParams nearestVehicle(vector<vector<int>> roadd, int overtake);
